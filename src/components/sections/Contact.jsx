                ...
                <form className='space-y-6' onSubmit={handleSubmit}>
                    ...
                    <div className='relative'>
                        <input 
                            ...
                            required
                            value={formData.name}
                            className='w-full bg-[#1B262C] border border-[#0F4C75] rounded-lg px-4 py-3 text-[#F1EFEC] placeholder-[#3E5879]/60 transition-colors duration-300 focus:outline-none focus:border-[#3E5879] focus:bg-blue-500/10 focus:ring-2 focus:ring-[#3E5879]/20'
                            placeholder='Name...'
                            onChange={(e) =>
